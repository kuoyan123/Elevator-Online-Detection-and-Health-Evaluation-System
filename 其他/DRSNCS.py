...
class RSNet(nn.Module):
    ...
    def __init__(self, block, num_block, out_channel=5):
        ...
        self.fc = nn.Linear(128 * block.expansion, out_channel)
...
def _rsnet(arch, block, num_block, **kwargs):
    model = RSNet(block, num_block, **kwargs)
    return model
...
def rsnet18(**kwargs):
    ...
    """
    return _rsnet('rsnet18', BasicBlock, [2, 2, 2, 2], **kwargs)
